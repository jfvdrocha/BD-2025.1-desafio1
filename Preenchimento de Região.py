...
def preencher_regiao_recursiva(matriz, linha, coluna, passos_visualizacao, contador_passos):
    ...
    contador_passos = preencher_regiao_recursiva(matriz, linha-1, coluna, passos_visualizacao, contador_passos)
    contador_passos = preencher_regiao_recursiva(matriz, linha+1, coluna, passos_visualizacao, contador_passos)
    contador_passos = preencher_regiao_recursiva(matriz, linha, coluna-1, passos_visualizacao, contador_passos)
    contador_passos = preencher_regiao_recursiva(matriz, linha, coluna+1, passos_visualizacao, contador_passos)
